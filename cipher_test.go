...
func TestCipher_IsEqualToTypedNil(t *testing.T) {
	var cipher *Cipher
	var ciphers *Ciphers

	require.False(t, CipherAes256Gcm.IsEqualTo(cipher))
	require.False(t, Ciphers{CipherAes256Gcm}.IsEqualTo(ciphers))
}
