...
func TestMessageAuthentication_IsEqualToTypedNil(t *testing.T) {
	var messageAuthentication *MessageAuthentication
	var messageAuthentications *MessageAuthentications

	require.False(t, MessageAuthenticationHmacSha2B256Etm.IsEqualTo(messageAuthentication))
	require.False(t, MessageAuthentications{MessageAuthenticationHmacSha2B256Etm}.IsEqualTo(messageAuthentications))
}
