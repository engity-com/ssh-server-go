...
func TestKeyExchange_IsEqualToTypedNil(t *testing.T) {
	var keyExchange *KeyExchange
	var keyExchanges *KeyExchanges

	require.False(t, KeyExchangeCurve25519Sha256.IsEqualTo(keyExchange))
	require.False(t, KeyExchanges{KeyExchangeCurve25519Sha256}.IsEqualTo(keyExchanges))
}
