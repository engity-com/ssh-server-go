...
1. [Fork this repository](https://github.com/engity-com/ssh-server-go/fork), develop, and test your changes.
...
1. Changes are manually reviewed by Engity's team members.
2. When the PR passes all tests, the PR is merged by the reviewer(s) in the GitHub [`main` branch](https://github.com/engity-com/ssh-server-go/tree/main).
